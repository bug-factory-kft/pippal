...
class TestMakeBackend:
    ...
    def test_unregistered_engine_falls_back_quietly(self):
        # If the user has e.g. 'kokoro' in their config (a Pro plugin
        # name) the Free build still returns a usable Piper backend
        # rather than raising — codex' graceful-degradation principle.
